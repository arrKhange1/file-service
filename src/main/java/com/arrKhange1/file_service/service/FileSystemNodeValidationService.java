...
public class FileSystemNodeValidationService {
    ...
    public void nodeEqualToParent(ObjectId nodeId, ObjectId parentId) {
        if (nodeId.equals(parentId)) throw new GeneralFileSystemNodeException("Node can't be a parent of itself");
    }
